...
def load_data(data_name, split, data_dir="./data"):
    ...
    if os.path.exists(data_file):
        ...
        if data_name == "math":
            ...
            # Load math500 from local directory
            dataset = load_jsonl(f"{data_dir}/math500/test.jsonl")
            ...
            dataset_i = load_jsonl(f"{data_dir}/aime25/aime2025-I.jsonl")
            dataset_ii = load_jsonl(f"{data_dir}/aime25/aime2025-II.jsonl")
